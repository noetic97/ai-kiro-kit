---
name: update-context
description: Refresh .kiro/steering/context.md with current project state. Use at the end of a session or when focus shifts.
...
Refresh `.kiro/steering/context.md` to reflect the current state of the project.

## Instructions

Read the current `.kiro/steering/context.md` first, then ask the following questions one at a time.
